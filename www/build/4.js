...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__photo_list__ = __webpack_require__(455);
...
var PhotoListPage = (function () {
    function PhotoListPage(camera, emailComposer, alertCtrl, navCtrl, navParams, eventProvider) {
        this.camera = camera;
    ...
    PhotoListPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.eventProvider.getPhotoList().on('value', function (snapshot) {
            _this.photoList = [];
